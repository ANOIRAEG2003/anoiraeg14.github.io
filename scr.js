...
for(let i=1;i<=8;i++){
    ...
    group.style.backgroundImage="url(puurple.png)";
...
select.style.backgroundImage="url(blue.png)";
...
onload=function(){document.body.style.backgroundImage="url(459817.jpg)";}
onresize=function(){document.body.style.backgroundImage="url(64c9dc2a9f4d14e51675a26a54a0e72e.jpg)";}
